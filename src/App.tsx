...
const MOCK_KEYS: VlessKey[] = [
  ...
  },
  {
    id: 5,
    name: 'Сервер №5',
    location: 'Россия, for telegram',
    protocol: 'VLESS',
    latency: '0ms',
    load: 0,
    config: 'vless://13076c68-ad61-4e0a-98fb-33e2b19013d3@ru01-blh03.tcp-reset-club.net:443?encryption=none&flow=xtls-rprx-vision&security=reality&sni=rutube.ru&fp=chrome&pbk=mLmBhbVFfNuo2eUgBh6r9-5Koz9mUCn3aSzlR6IejUg&sid=d3b13f31&spx=%2F&type=tcp&headerType=none',
